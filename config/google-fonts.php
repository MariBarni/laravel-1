...
return [
    ...
    'fonts' => [
        ...
        'Roboto'=> 'https://fonts.googleapis.com/css2?family=Roboto+Slab:wght@700&display=swap',
        'Roboto+Slab'=>'https://fonts.googleapis.com/css2?family=Roboto+Slab:wght@700&display=swap',
    ],
