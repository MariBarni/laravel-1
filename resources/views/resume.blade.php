    ...
    @if (count($experiences) > 0)
      <div class="w3-container w3-card w3-white w3-margin-bottom">
            ...
            <div class="w3-container">
                ...
                <h6 class="w3-text-teal"><i class="fa fa-calendar  w3-margin-right"></i>{{$exp->started_at->format('d/m/Y')}} - @if ($exp->finished_at == null) heute @else {{ $exp->finished_at?->format('d/m/Y') }}  @endif</h6>
                <p>{{$exp->description}}</p>
                <hr>
            </div>
            @endforeach  
    ...
    <!-- Bildungsweg  -->   
      <div class="w3-container w3-card w3-white">
        ...
        <div class="w3-container">
          ...
          <h6 class="w3-text-teal"><i class="fa fa-calendar  w3-margin-right"></i>{{$edu->started_at->format('d/m/Y')}} - @if ($edu->finished_at == null) heute @else {{ $edu->finished_at?->format('d/m/Y') }} @endif</h6>
