    ...
    @if (count($profile->experiences) > 0)
      <div class="w3-container w3-card w3-white w3-margin-bottom">
            ...
            <div class="w3-container">
                ...
                <h6 class="w3-text-blue"><i class="fa fa-calendar  w3-margin-right"></i>{{$exp->started_at->format('d/m/Y')}} - {{ $exp->finished_at?->format('d/m/Y') }}  </h6>
                <p>{{$exp->description}}</p>
                <hr>
            </div>
            @endforeach  
    ...
    <!-- Bildungsweg  -->   
      <div class="w3-container w3-card w3-white">
        ...
        <div class="w3-container">
          ...
          <h6 class="w3-text-blue"><i class="fa fa-calendar  w3-margin-right"></i>{{$edu->started_at->format('d/m/Y')}} - {{ $edu->finished_at?->format('d/m/Y') }}</h6>
