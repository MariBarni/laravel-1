            ...
            <div class="left-item">
                ...
                <ul>
                    <li><img class="icon" src="{{ asset('storage/icons/envelope-fill-2.png') }}" >{{$profile->email}}</li>
                     ...
                     @else
                    <li><img class="icon" src="{{ asset('storage/icons/phone-fill-2.png') }}" >{{$profile->telefonnummer}}</li>
                    @endif
                    ...
                    @else
                    <li><img class="icon" src="{{ asset('storage/icons/cake2-fill-2.png') }}" ></i>{{$profile->geburtstag?->format('d.m.Y')}}</li>
                     @endif
                </ul>
            </div>
